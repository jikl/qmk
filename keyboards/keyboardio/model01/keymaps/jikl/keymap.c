...
enum layers {_Q_, _L_, _F_, _N_};
//
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
[_Q_] = LAYOUT(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_CAPS,
    MO(_L_), KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    RGB_MOD,    _______, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    MO(_L_),
    KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_TAB,     KC_ENT,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SPC,  KC_RSFT,
    MO(_F_), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_ESC,     TG(_N_), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_TAB,  MO(_F_),
                                           KC_ENT,                                 KC_ENT,
                                              KC_LGUI,                           KC_RGUI,
                                                 KC_LCTL,                     KC_RCTL,
                                                    KC_LALT,               KC_RALT,
...
[_L_] = LAYOUT(
    ...
    _______, KC_HASH, KC_LBRC, KC_QUOT, KC_RBRC, KC_PERC, _______,    _______, KC_EQL,  KC_LABK, KC_TILD, KC_RABK, KC_CIRC, _______,
    _______, KC_DLR,  KC_BSLS, KC_DQT,  KC_SLSH, KC_ASTR, _______,    _______, KC_PLUS, KC_LPRN, KC_MINS, KC_RPRN, _______, _______,
    _______, KC_AT,   KC_LCBR, KC_GRV,  KC_RCBR, KC_UNDS, _______,    _______, KC_AMPR, KC_PIPE, KC_EXLM, KC_QUES, _______, _______,
                                           _______,                                 _______,
                                              _______,                           _______,
                                                 _______,                     _______,
                                                    _______,               _______,
